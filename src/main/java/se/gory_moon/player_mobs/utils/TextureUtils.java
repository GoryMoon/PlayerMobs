...
public class TextureUtils {
    ...
    public static final ResourceLocation HIDE_FEATURE = new ResourceLocation(Constants.MOD_ID, "hide_feature");
    ...
    public static Optional<ResourceLocation> getPlayerElytra(PlayerMobEntity entity) {
        ...
        return getTexture(entity, MinecraftProfileTexture.Type.ELYTRA);
    }
        ...
        if (profile != null && profile.getName() != null) {
            ...
            if (map.containsKey(type)) {
                ...
                if (mc.textureManager.getTexture(location, MissingTextureAtlasSprite.getTexture()) != MissingTextureAtlasSprite.getTexture()) {
                    ...
                    RenderSystem.recordRenderCall(() -> mc.getSkinManager().registerTexture(profileTexture, type, entity.getSkinCallback()));
                }
            }
