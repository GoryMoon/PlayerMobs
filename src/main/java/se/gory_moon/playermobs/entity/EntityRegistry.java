...
import se.gory_moon.playermobs.Constants;
import se.gory_moon.playermobs.PlayerMobs;
import se.gory_moon.playermobs.client.render.PlayerMobRenderer;

public class EntityRegistry {

    private static final Registrate REGISTRATE = PlayerMobs.getRegistrate();
    ...
    public static final EntityEntry<PlayerMobEntity> PLAYER_MOB_ENTITY = REGISTRATE.object(Constants.PLAYER_MOB_ENTITY)
            ...
            .properties(builder -> builder.size(0.6F, 1.8F).trackingRange(4).func_233608_b_(5))
